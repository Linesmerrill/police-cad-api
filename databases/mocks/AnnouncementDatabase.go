...
// AnnouncementDatabase is an autogenerated mock type for the AnnouncementDatabase type
type AnnouncementDatabase struct {
	mock.Mock
}

// Aggregate provides a mock function with given fields: ctx, pipeline, opts
func (_m *AnnouncementDatabase) Aggregate(ctx context.Context, pipeline mongo.Pipeline, opts ...*options.AggregateOptions) (*databases.MongoCursor, error) {
...
func (_m *AnnouncementDatabase) CountDocuments(ctx context.Context, filter interface{}, opts ...*options.CountOptions) (int64, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *AnnouncementDatabase) DeleteOne(ctx context.Context, filter interface{}, opts ...*options.DeleteOptions) error {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *AnnouncementDatabase) Find(ctx context.Context, filter interface{}, opts ...*options.FindOptions) (databases.MongoCursor, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *AnnouncementDatabase) FindOne(ctx context.Context, filter interface{}) (*models.Announcement, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, interface{}) (*models.Announcement, error)); ok {
		return rf(ctx, filter)
	}
	if rf, ok := ret.Get(0).(func(context.Context, interface{}) *models.Announcement); ok {
		r0 = rf(ctx, filter)
	} else {
		if ret.Get(0) != nil {
...
func (_m *AnnouncementDatabase) FindOneAndUpdate(ctx context.Context, filter interface{}, update interface{}, opts ...*options.FindOneAndUpdateOptions) (*models.Announcement, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *models.Announcement
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, interface{}, interface{}, ...*options.FindOneAndUpdateOptions) (*models.Announcement, error)); ok {
		return rf(ctx, filter, update, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, interface{}, interface{}, ...*options.FindOneAndUpdateOptions) *models.Announcement); ok {
...
// InsertOne provides a mock function with given fields: ctx, announcement, opts
func (_m *AnnouncementDatabase) InsertOne(ctx context.Context, announcement models.Announcement, opts ...*options.InsertOneOptions) (databases.InsertOneResultHelper, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, ctx, announcement)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, models.Announcement, ...*options.InsertOneOptions) (databases.InsertOneResultHelper, error)); ok {
		return rf(ctx, announcement, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, models.Announcement, ...*options.InsertOneOptions) databases.InsertOneResultHelper); ok {
		r0 = rf(ctx, announcement, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, models.Announcement, ...*options.InsertOneOptions) error); ok {
		r1 = rf(ctx, announcement, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *AnnouncementDatabase) UpdateOne(ctx context.Context, filter interface{}, update interface{}, opts ...*options.UpdateOptions) error {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// NewAnnouncementDatabase creates a new instance of AnnouncementDatabase. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewAnnouncementDatabase(t interface {
	mock.TestingT
	Cleanup(func())
}) *AnnouncementDatabase {
	mock := &AnnouncementDatabase{}
	mock.Mock.Test(t)
