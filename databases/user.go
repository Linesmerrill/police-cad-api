...
func (u *userDatabase) FindOne(ctx context.Context, filter interface{}, opts ...*options.FindOneOptions) SingleResultHelper {
	// user := &models.User{}
	return u.db.Collection(userName).FindOne(ctx, filter, opts...)
	// if err != nil {
	// 	return nil, err
	// }
	// return user, nil
