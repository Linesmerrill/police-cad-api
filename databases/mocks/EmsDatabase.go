...
func (_m *EmsDatabase) Find(_a0 context.Context, _a1 interface{}, _a2 ...*options.FindOptions) ([]models.Ems, error) {
	...
	var r0 []models.Ems
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, interface{}, ...*options.FindOptions) ([]models.Ems, error)); ok {
...
func (_m *EmsDatabase) FindOne(_a0 context.Context, _a1 interface{}, _a2 ...*options.FindOneOptions) (*models.Ems, error) {
	...
	var r0 *models.Ems
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, interface{}, ...*options.FindOneOptions) (*models.Ems, error)); ok {
		return rf(_a0, _a1, _a2...)
	}
...
// NewEmsDatabase creates a new instance of EmsDatabase. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewEmsDatabase(t interface {
	mock.TestingT
	Cleanup(func())
}) *EmsDatabase {
	mock := &EmsDatabase{}
