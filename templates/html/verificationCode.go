...
// RenderCode generates the HTML for the verification code email
func RenderCode(code string) string {

	return fmt.Sprintf("%v%v%v", verificationHTMLHeader, code, verificationBody)
}

// VerificationHTML is the HTML template for the verification code email
const verificationHTMLHeader = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
...
body {font-family: 'Muli', sans-serif;}
  ...
  <![endif]-->
    ...
    <tr>
      <td role="module-content">
        <p>Account Creation Verification Code</p>
      </td>
    </tr>
    ...
    <tbody>
      <tr>
        <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 43px">Verification Code</span></div><div></div></div></td>
      </tr>
    </tbody>
  </table><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="a10dcb57-ad22-4f4d-b765-1d427dfddb4e" data-mc-module-version="2019-10-22">
    <tbody>
      <tr>
        <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 18px">Please use the following verification code to verify your email with Lines Police CAD</span></div><div></div></div></td>
      </tr>
    </tbody>
  ...
  </table><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="4c4b19a8-ae61-4847-8857-19a54a355a38" data-mc-module-version="2019-10-22">
    <tbody>
      <tr>
        <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 24px">`

const verificationBody = `</span></div><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit">If you need assistance, please visit the <a href="https://www.linespolice-cad.com/contact-us">Lines Police CAD Help Center</a></div><div></div></div></td>
      </tr>
    </tbody>
  </table></td>
        </tr>
