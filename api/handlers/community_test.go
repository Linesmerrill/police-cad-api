...
func TestCommunity_CommunityByOwnerHandlerMultiError(t *testing.T) {
	...
	expected := `{"response": "failed to get objectID from Hex, the provided hex string is not a valid ObjectID"}{"_id":"mocked-user","community":{"name":"","ownerID":"","code":"","activePanics":null,"activeSignal100":false,"createdAt":"1969-12-31T17:00:00-07:00","updatedAt":"1969-12-31T17:00:00-07:00"},"__v":0}`
	if rr.Body.String() != expected {
		t.Errorf("handler returned unexpected body: got %v want %v", rr.Body.String(), expected)
	}
}
