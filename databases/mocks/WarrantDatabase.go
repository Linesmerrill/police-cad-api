...
func (_m *WarrantDatabase) Find(ctx context.Context, filter interface{}, opts ...*options.FindOptions) ([]models.Warrant, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, interface{}, ...*options.FindOptions) ([]models.Warrant, error)); ok {
...
func (_m *WarrantDatabase) FindOne(ctx context.Context, filter interface{}, opts ...*options.FindOneOptions) (*models.Warrant, error) {
	...
	var r0 *models.Warrant
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, interface{}, ...*options.FindOneOptions) (*models.Warrant, error)); ok {
		return rf(ctx, filter, opts...)
	}
...
// NewWarrantDatabase creates a new instance of WarrantDatabase. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewWarrantDatabase(t interface {
	mock.TestingT
	Cleanup(func())
}) *WarrantDatabase {
	mock := &WarrantDatabase{}
	mock.Mock.Test(t)
